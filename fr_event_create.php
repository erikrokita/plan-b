...
if ( !empty($_POST)) { // if not first time through
	...
	if ($valid) {
		...
		$sql = "INSERT INTO fr_events (htmlspecialchars(event_date), htmlspecialchars(event_time), htmlspecialchars(event_location), htmlspecialchars(event_description), filename,filesize,filetype,filecontent) values(?, ?, ?, ?, ?, ?, ?, ?)";
		$q = $pdo->prepare($sql);
